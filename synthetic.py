...
if __name__ == "__main__":
    ...
    model = Isomap(n_neighbors=15, n_components=2, eigen_solver='dense')
    X_recovered = model.fit_transform(XS)

    # Rotate axes via ICA
    ica = FastICA(random_state=rng)
    S_ica_ = ica.fit(X_recovered).transform(X_recovered)  # Estimate the sources
